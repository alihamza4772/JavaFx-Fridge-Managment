...
public class Grocery {
    ...
    private int id;
    private Item item;
    private String date; // when was it bought or added to fridge; read-only will be set in constructor
    private int quantity; // read-only, set in constructor, defaults to 1
    private String section;

    // constructor
    public Grocery(int id, Item item, String date, int quantity, String section) throws Exception {
        if (id < 1)
    ...
    // constructor
    public Grocery(int id, Item item, String date, String section) throws Exception {
    ...
    public String getDaysAgo() throws ParseException {
    ...
    public String toString() {
        ...
        String daysAgo = null;
        try {
            daysAgo = FridgeDSC.calcDaysAgoStr(date);
